...
- ![nuevo icono](../../assets/new.svg) **Actualizaciones de Docker**—
   ...
   - ![nuevo icono](../../assets/new.svg) Ahora, el entorno Docker admite la configuración de cron definida en la propiedad [crons del archivo .magento.app.yaml](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/configure/app/properties/crons-property).<!-- MAGECLOUD-3150 -->
...
- ![nuevo icono](../../assets/new.svg) **Configurar con constantes de PHP**—Se ha agregado compatibilidad con [constantes de PHP](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/configure/env/configure-env-yaml#php-constants) en el archivo de configuración `.magento.env.yaml`.<!-- MAGECLOUD- 2575 -->
...
- **Archivo de configuración unificado**: Ahora puede configurar las fases de generación e implementación mediante un archivo [`.magento.env.yaml`](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/configure/env/configure-env-yaml).<!-- MAGECLOUD-1369 -->
