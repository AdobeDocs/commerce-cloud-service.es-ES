...
- ![nuevo icono](../../assets/new.svg) **Se agregó compatibilidad con Eventos de Adobe I/O para Adobe Commerce**. Los desarrolladores de extensiones ahora pueden usar el módulo [Eventos de Adobe I/O](https://developer.adobe.com/events/docs/) para enviar información de eventos de Commerce desde instancias de nube a sus aplicaciones escritas para [App Builder de Adobe](https://developer.adobe.com/app-builder/docs/overview/). Los eventos de Adobe I/O para Adobe Commerce se encuentran en la vista previa para socios.<!-- CEXT-932 -->
