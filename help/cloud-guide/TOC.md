---
user-guide-title: Guía de Commerce en la infraestructura en la nube
...
+ Notas de versión {#release-notes}
   ...
   + [Paquetes de nube (beta)](release-notes/cloud-packages-beta.md)
...
+ Servicios rápidos {#cdn}
   ...
   + Personalizar con VCL {#custom-vcl-snippets}
      ...
      + [Redireccionar solicitudes a un servidor CMS](cdn/fastly-vcl-wordpress.md)
